...
STAR  --runThreadN $threads --genomeDir $star_ref --readFilesIn 'Trimed_'$name*'.fastq' --outFilterMismatchNoverLmax 0.1 --outFilterMatchNmin 16 --outFilterScoreMinOverLread 0 --outFilterMatchNminOverLread 0   --outFileNamePrefix  'step2.1_Star_'$name'_'  --outWigType bedGraph --outWigNorm RPM --outSAMtype BAM  SortedByCoordinate  
